...
# === ABOUT US ===
    ...
    st.markdown("""<h1>About Echolens</h1>
    <p style='text-align:center;'>We are a passionate team of AI developers turning vision into insight through video analysis and storytelling.</p>""", unsafe_allow_html=True)
    st.markdown("""<h2 style='text-align:center;'>Our Team</h2><div class='team-grid'>""", unsafe_allow_html=True)

    team_members = [
        {"name": "Aya Tamer (Leader)", "role": "AIS", "img": "aya_tamer.png"},
    ...
    for member in team_members:
        ...
        <div class='team-card'>
            ...
            <strong>{member['name']}</strong><br><span style='color:#ccc'>{member['role']}</span>
        </div>
        """, unsafe_allow_html=True)
